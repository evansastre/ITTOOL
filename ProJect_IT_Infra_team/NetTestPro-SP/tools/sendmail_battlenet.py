...
file_name = tempdir+"\NetTestPro_battlenet.txt" #附件名
...
def sendmail(Resetuser):
    ...
    #maillist = ['hzhuangshilei@corp.corpname.com']
    maillist = ['hzhuangshilei@corp.corpname.com','xiexiaofeng@corp.corpname.com']  #发送给操作者，被操作账号，IT三方 #  
