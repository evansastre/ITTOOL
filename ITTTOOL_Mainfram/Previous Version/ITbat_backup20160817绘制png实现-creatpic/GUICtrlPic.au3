...
; Description ...: Erg?nzende Funktionen f¨¹r Pic-Controls (Additional functions for Pic-Controls)
; Author(s) .....: Gro?vater
...
; Description ...: Pic-Control f¨¹r alle von GDIPlus unterst¨¹tzten Formate ggf. mit Transparenz erstellen.
...
;                  $bKeepAspectRatio - Seitenverh?ltnis bei der Gr??enanpassung beachten:
;                  |True    - ja
;                  |False   - nein
;                  |Default - nein
; Return values .: Im Erfolgsfall: ControlID aus GUICtrlCreatePic()
;                  Im Fehlerfall: False, @error und @extended enthalten erg?nzende fehlerbeschreibende Werte.
...
;                  $sPicPath         - vollst?ndiger Pfad der Bilddatei
;                  $bKeepAspectRatio - Seitenverh?ltnis bei der Gr??enanpassung beachten: (Aspect ratio in mind when sizing)
;                  |True    - ja
;                  |False   - nein
;                  |Default - nein
; Return values .: Im Erfolgsfall: True  (If successful)
;                  Im Fehlerfall: False, @error und @extended enthalten ggf. erg?nzende fehlerbeschreibende Werte
...
; Parameters ....: $sPicPath         - vollst?ndiger Pfad der Bilddatei
; Return values .: Im Erfolgsfall: Array mit drei Eintr?gen, Array[0] enth?lt ein HBITMAP-Handle,
;                                  Array[1] die Breite und Array[2] die H?he der Bitmap
;                  Im Fehlerfall: False, @error und @extended enthalten ggf. erg?nzende fehlerbeschreibende Werte
; Author ........: Gro?vater (www.autoit.de)
; Modified.......:
...
;                  $iNewW            - gew¨¹nschte Breite in Pixeln
;                  $iNewH            - gew¨¹nschte H?he in Pixeln
;                  $iBitmapW         - aktuelle Breite der Bitmap (wird nur f¨¹r das Skalieren im Seitenverh?ltnis ben?tigt
;                  $iBitmapH         - aktuelle H?he der Bitmap (wird nur f¨¹r das Skalieren im Seitenverh?ltnis ben?tigt
;                  $bKeepAspectRatio - Seitenverh?ltnis bei der Gr??enanpassung beachten:
;                  |True    - ja
;                  |False   - nein
;                  |Default - nein
; Return values .: Im Erfolgsfall: HBITMAP-Handle f¨¹r die skalierte Bitmap
;                  Im Fehlerfall: False, @error und @extended enthalten ggf. erg?nzende fehlerbeschreibende Werte
; Author ........: Gro?vater (www.autoit.de)
; Modified.......:
...
; Description ...: F¨¹llt ein Pic-Control mit einem zweifarbigen linearen Farbverlauf.
...
;                  $BH      - H?he des Verlaufs in Pixeln
;                  |Default - 0 (H?he des Controls)
; Return values .: Bei erfolgreicher Ausf¨¹hrung: Handle der erzeugten Bitmap (HBITMAP)
