...
Func Example()
    ...
    GUICreate("Button UDF 示例", 510, 400)
    GUISetState(@SW_SHOW)
    ...
    $a_idRdo[0] = GUICtrlCreateRadio("单选Button 1", 120, 10, 120, 25)
    _GUICtrlButton_SetImageList($a_idRdo[0], $hImageSmall)

    $a_idChk[0] = GUICtrlCreateCheckbox("复选Button 1", 260, 10, 120, 25)
    ...
    For $x = 1 To 5
        ...
        $a_idRdo[$x] = GUICtrlCreateRadio("单选Button" & $x + 1, 120, $y, 120, 25)
        _GUICtrlButton_SetImageList($a_idRdo[$x], _GetImageListHandle("shell32.dll", $iIcon + $x), $x)
        $a_idChk[$x] = GUICtrlCreateCheckbox("复选Button" & $x + 1, 260, $y, 120, 25)
