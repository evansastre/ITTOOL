...
;~ 	FileInstall("itbat_materials\ITbat.ico", @TempDir & "\itbat_materials\ITbat.ico")
    Global $itbat_materials="robocopy \\ITTOOL_node1\ITTOOLS\Conf\ITbat\itbat_materials  %temp%\itbat_materials /mir"
    Global $button_icons="robocopy \\ITTOOL_node1\ITTOOLS\Conf\ITbat\button_icons  %temp%\button_icons /mir"
	...
	Global $select_ico=@TempDir & "\itbat_materials\normal select.ani"
...
;~ 	Global $mp3=@TempDir&"\itbat_materials\Merry Christmas Mr.Lawrence.mp3"
	Global $mp3=@TempDir&"\itbat_materials\OwlCity - Victory Theme.mp3"
