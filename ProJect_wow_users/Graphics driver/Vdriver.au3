...
#AccAu3Wrapper_OutFile_x64=Y:\显卡驱动\Vdriver.exe
...
Func judgeLocation()
	...
	If $sh==_Min( $sh, $hz ) Then  ;  The smaller the value, the faster, that is, the closer
		$location = 'SH'
		$office2007="\\ITTOOL_node2\ITTOOLS\软件部署\显卡驱动\375.70-desktop-win8-win7-64bit-international-whql.exe"
		
		
	ElseIf $hz==_Min ( $sh, $hz ) Then 
		$location = 'HZ'
		$office2007="\\ITTOOL_node1\ITTOOLS\软件部署\显卡驱动\375.70-desktop-win8-win7-64bit-international-whql.exe"
