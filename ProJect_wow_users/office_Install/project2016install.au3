...
#AccAu3Wrapper_OutFile_x64=Y:\Office\project2016install.exe
...
Func judgeLocation()
	...
	If $sh==_Min( $sh, $hz ) Then  ;  The smaller the value, the faster, that is, the closer
		$location = 'SH'
		$project2016="\\ITTOOL_node2\ITTOOLS\SoftwareDeploy\SW_DVD5_Project_Pro_2016_64Bit_ChnSimp_MLF_X20-42676\setup.exe"

		
		
	ElseIf $hz==_Min ( $sh, $hz ) Then 
		$location = 'HZ'
		$project2016="\\ITTOOL_node1\ITTOOLS\SoftwareDeploy\SW_DVD5_Project_Pro_2016_64Bit_ChnSimp_MLF_X20-42676\setup.exe"

		
	EndIf
	
	Global $runInstall[1]=[$project2016]
	runBat($runInstall)
    
EndFunc

Func autoInstall()
	WinWaitActive("Microsoft Project Professional 2016")
	Send("!A")
	Send("!C")
	Sleep(1000)
	Send("!I")
	While	WinExists("Microsoft Project Professional 2016") 
