...
#AccAu3Wrapper_OutFile_x64=Y:\Office\visio2007uninstall.exe
...
Func judgeLocation()
	...
	If $sh==_Min( $sh, $hz ) Then  ;  The smaller the value, the faster, that is, the closer
		$location = 'SH'
		$office2007="\\ITTOOL_node2\ITTOOLS\SoftwareDeploy\Visio_Pro_2007\setup.exe"
		
		
	ElseIf $hz==_Min ( $sh, $hz ) Then 
		$location = 'HZ'
		$office2007="\\ITTOOL_node1\ITTOOLS\SoftwareDeploy\Visio_Pro_2007\setup.exe"
