...
#AccAu3Wrapper_OutFile=Y:\The corp account related webpage password is automatically filled in and logged in..exe
...
;~ 	Login("http://1.163.com/service/corpname/login.do")
;~ Else
...
Func GETMANUALINPUT(ByRef $webaddress) 
	...
	GUICtrlSetData(-1, "ks.corpname.com|e-benefits.blz.corpname.com", "ks.corpname.com")
