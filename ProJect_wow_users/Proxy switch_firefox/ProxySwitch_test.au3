...
#AccAu3Wrapper_OutFile=Y:\FirefoxProxySwitch\FirefoxProxySwitch.exe
...
;~ 	MsgBox(0,"",$startSetLine&@LF&$lineNUM)
	...
	;PAC
	_FileWriteToLine($prefsJs,$startSetLine,'user_pref("network.proxy.autoconfig_url", "file://///bnportal/PAC/proxy.pac");',0) 
