...
;~ $Button=_GUICtrlPic_Create(@ScriptDir&"\Button3.png", 500, 300, 115,161,-1,-1,False)
$Button=_GuiCtrlCreatePNG(@ScriptDir&"\Button3.png", 500, 300, $hWNDMain)
