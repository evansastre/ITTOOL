...
;~ 	GUICtrlSetDefBkColor(0x282828)
	...
	$version_label=GUICtrlCreateLabel($version, 750, 580, 38,32)
...
;~ 	;———————————————————————————————————————————————————————————————
	...
	;标签页
	Global $idTab = GUICtrlCreateTab(10, 50, 780, 500,BitOR($TCS_MULTILINE,$TCS_RIGHTJUSTIFY,$TCS_FLATBUTTONS),$WS_EX_WINDOWEDGE);$WS_EX_DLGMODALFRAME    $TCS_SCROLLOPPOSITE
